...
*/
    ...
    if(altura !=='' && peso !==''){
     const valorIMC = (peso / (altura * altura)).toFixed(1); /*if é usada para testar uma condição*/
   ...
   */
        ...
        resultado.textContent = `Preencha todos os campos!!`;  /* permite ao programa avaliar uma expressão como sendo verdadeira ou falsa*/
    }
